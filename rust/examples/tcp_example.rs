// Example: Using TCP transport (requires feature = "tcp")
//
// Run with: cargo run --example tcp_example --features tcp
...
async fn main() -> anyhow::Result<()> {
    ...
    let client = Client::new(
        ClientOptions::new()
            .use_stdio(false) // Use TCP transport
    ...
    // Send a message
    println!("Sending message via TCP...");
    session
        .send(MessageOptions {
